...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="index.html" style="background-image: url('{{asset('/clean/assets/img/logo.png')}}'); height:100px; width:300px; background-size: contain; background-repeat: no-repeat"></a>
